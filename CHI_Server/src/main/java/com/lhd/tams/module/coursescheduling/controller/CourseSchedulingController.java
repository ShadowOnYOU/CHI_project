...
public class CourseSchedulingController extends BaseController {
    ...
    public ResponseEntity<ApiResult<Long>> getConflictStudentNum(@RequestParam Long courseId,
                                                                    @RequestParam String date,
                                                                    @RequestParam String attendTime){

        return success(courseSchedulingService.conflictStudentNum(courseId, date, attendTime));
    }
}
